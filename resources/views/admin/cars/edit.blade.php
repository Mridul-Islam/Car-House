...
@section('content')
    ...
    <h2 class="text-center bg-info">Update Car</h2>
    <hr>
    ...
    <div class="col-md-12">
        {!! Form::model($car, ['method'=>'PATCH', 'route'=>['cars.update', $car->id], 'files'=>true]) !!}
        ...
        <div class="form-group">
            {!! Form::submit('Update Car', ['class'=>'btn btn-primary form-control']) !!}
        </div>
        {!! Form::close() !!}
    </div>
